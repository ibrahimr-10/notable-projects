...
// Query to get total assists by each user
$query = "SELECT u.username, SUM(ps.assists) AS total_assists
FROM users u
...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $data[] = array($row['username'], (int)$row['total_assists']);
    }
} else {
...
<head>
    <meta charset="UTF-8">
    <title>User Assists Performance</title>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                chart: {
                    title: 'Top 10 Users by Total Assists',
                    subtitle: 'Showing the total assists made by the top 10 users',
                },
